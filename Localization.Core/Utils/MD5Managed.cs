// Modified version of http://blogs.msdn.com/b/delay/archive/2010/12/06/hash-for-the-holidays-managed-implementation-of-crc32-and-md5-algorithms-updated-new-release-of-computefilehashes-for-silverlight-wpf-and-the-command-line.aspx?Redirected=true
using System;
using System.Diagnostics.CodeAnalysis;

namespace Localization.Core.Utils
{
    /// <summary>
    ...
    sealed class MD5Managed
    {
        ...
        public void HashCore(byte[] array, int ibStart, int cbSize)
        {
            ...
            if (_hashFinalCalled)
                throw new InvalidOperationException("Hash not valid for use in specified state.");
